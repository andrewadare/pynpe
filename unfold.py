...
# ymin = 0.01 * gpt
# ymax = 2 * gpt
ylims = np.vstack((0.01 * gpt, 2 * gpt)).T # Solution boundary (ndim x 2)
...
if use_all_data:
    ...
    args = [eptmatw, ept[:,0], icov_data, gpt, alpha, ylims, L]
...
pf.plot_result(ylims, p0, gpt, pq, 'pdfs/test/hpt.pdf')
